...
export default function Register() {
    ...
    const wallet_address = useRef()  // New reference for the wallet address
    ...
    async function onSubmitForm(event) {
        ...
        const data = {
            ...
            wallet_address: wallet_address.current.value  // Include wallet address in form data
        };
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="text" placeholder='Ethereum Wallet Address' autoComplete='off' className='form-control' id="wallet_address" ref={wallet_address} />  {/* New input for wallet address */}
                </div>
                <div className="mb-3">
